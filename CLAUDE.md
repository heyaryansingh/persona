...
- **Cache aggressively for the demo** (Europe PMC, Open Targets, dataset lookups, and any pre-run Claude Science result) so nothing live can break the money-shot.
